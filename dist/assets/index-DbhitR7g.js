...
`)+`
`+p);const y=_+m+o,M=_+p+a,T=Hc(s,s.VERTEX_SHADER,y),b=Hc(s,s.FRAGMENT_SHADER,M);s.attachShader(x,T),s.attachShader(x,b),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(L){if(i.debug.checkShaderErrors){const B=s.getProgramInfoLog(x)||"",Y=s.getShaderInfoLog(T)||"",W=s.getShaderInfoLog(b)||"",F=B.trim(),G=Y.trim(),H=W.trim();let tt=!0,et=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(tt=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,T,b);else{const ut=Xc(s,T,"vertex"),St=Xc(s,b,"fragment");Ht("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,$g=[new P(1,0,0),new P(-1,0,0),new P(0,1,0),new P(0,-1,0),new P(0,0,1),new P(0,0,-1)],Jg=[new P(0,-1,0),new P(0,-1,0),new P(0,0,1),new P(0,0,-1),new P(0,-1,0),new P(0,-1,0)],Qc=new ue,Ji=new P,io=new P;function Qg(i,t,e){let n=new xa;const s=new gt,r=new gt,o=new _e,a=new td,c=new ed,l={},d=e.maxTextureSize,u={[ei]:qe,[qe]:ei,[Xe]:Xe},h=new bn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new gt},radius:{value:4}},vertexShader:jg,fragmentShader:Kg}),f=h.clone();f.defines.HORIZONTAL_PASS=1;const g=new ae;g.setAttribute("position",new Ge(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new le(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ys;let p=this.type;this.render=function(b,C,S){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;this.type===ah&&(wt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Ys);const R=i.getRenderTarget(),N=i.getActiveCubeFace(),L=i.getActiveMipmapLevel(),B=i.state;B.setBlending(Bn),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const Y=p!==this.type;Y&&C.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(F=>F.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,F=b.length;W<F;W++){const G=b[W],H=G.shadow;if(H===void 0){wt("WebGLShadowMap:",G,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;s.copy(H.mapSize);const tt=H.getFrameExtents();s.multiply(tt),r.copy(H.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(r.x=Math.floor(d/tt.x),s.x=r.x*tt.x,H.mapSize.x=r.x),s.y>d&&(r.y=Math.floor(d/tt.y),s.y=r.y*tt.y,H.mapSize.y=r.y));const et=i.state.buffers.depth.getReversed();if(H.camera._reversedDepth=et,H.map===null||Y===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===ts){if(G.isPointLight){wt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new Mn(s.x,s.y,{format:mi,type:Gn,minFilter:Oe,magFilter:Oe,generateMipmaps:!1}),H.map.texture.name=G.name+".shadowMap",H.map.depthTexture=new Vi(s.x,s.y,xn),H.map.depthTexture.name=G.name+".shadowMapDepth",H.map.depthTexture.format=Vn,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=De,H.map.depthTexture.magFilter=De}else G.isPointLight?(H.map=new kl(s.x),H.map.depthTexture=new gu(s.x,En)):(H.map=new Mn(s.x,s.y),H.map.depthTexture=new Vi(s.x,s.y,En)),H.map.depthTexture.name=G.name+".shadowMap",H.map.depthTexture.format=Vn,this.type===Ys?(H.map.depthTexture.compareFunction=et?ma:pa,H.map.depthTexture.minFilter=Oe,H.map.depthTexture.magFilter=Oe):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=De,H.map.depthTexture.magFilter=De);H.camera.updateProjectionMatrix()}const ut=H.map.isWebGLCubeRenderTarget?6:1;for(let St=0;St<ut;St++){if(H.map.isWebGLCubeRenderTarget)i.setRenderTarget(H.map,St),i.clear();else{St===0&&(i.setRenderTarget(H.map),i.clear());const Tt=H.getViewport(St);o.set(r.x*Tt.x,r.y*Tt.y,r.x*Tt.z,r.y*Tt.w),B.viewport(o)}if(G.isPointLight){const Tt=H.camera,Yt=H.matrix,$t=G.distance||Tt.far;$t!==Tt.far&&(Tt.far=$t,Tt.updateProjectionMatrix()),Ji.setFromMatrixPosition(G.matrixWorld),Tt.position.copy(Ji),io.copy(Tt.position),io.add($g[St]),Tt.up.copy(Jg[St]),Tt.lookAt(io),Tt.updateMatrixWorld(),Yt.makeTranslation(-Ji.x,-Ji.y,-Ji.z),Qc.multiplyMatrices(Tt.projectionMatrix,Tt.matrixWorldInverse),H._frustum.setFromProjectionMatrix(Qc,Tt.coordinateSystem,Tt.reversedDepth)}else H.updateMatrices(G);n=H.getFrustum(),M(C,S,H.camera,G,this.type)}H.isPointLightShadow!==!0&&this.type===ts&&_(H,S),H.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(R,N,L)};function _(b,C){const S=t.update(x);h.defines.VSM_SAMPLES!==b.blurSamples&&(h.defines.VSM_SAMPLES=b.blurSamples,f.defines.VSM_SAMPLES=b.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Mn(s.x,s.y,{format:mi,type:Gn})),h.uniforms.shadow_pass.value=b.map.depthTexture,h.uniforms.resolution.value=b.mapSize,h.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(C,null,S,h,x,null),f.uniforms.shadow_pass.value=b.mapPass.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(C,null,S,f,x,null)}function y(b,C,S,R){let N=null;const L=S.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(L!==void 0)N=L;else if(N=S.isPointLight===!0?c:a,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const B=N.uuid,Y=C.uuid;let W=l[B];W===void 0&&(W={},l[B]=W);let F=W[Y];F===void 0&&(F=N.clone(),W[Y]=F,C.addEventListener("dispose",T)),N=F}if(N.visible=C.visible,N.wireframe=C.wireframe,R===ts?N.side=C.shadowSide!==null?C.shadowSide:C.side:N.side=C.shadowSide!==null?C.shadowSide:u[C.side],N.alphaMap=C.alphaMap,N.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,N.map=C.map,N.clipShadows=C.clipShadows,N.clippingPlanes=C.clippingPlanes,N.clipIntersection=C.clipIntersection,N.displacementMap=C.displacementMap,N.displacementScale=C.displacementScale,N.displacementBias=C.displacementBias,N.wireframeLinewidth=C.wireframeLinewidth,N.linewidth=C.linewidth,S.isPointLight===!0&&N.isMeshDistanceMaterial===!0){const B=i.properties.get(N);B.light=S}return N}function M(b,C,S,R,N){if(b.visible===!1)return;if(b.layers.test(C.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&N===ts)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(S.matrixWorldInverse,b.matrixWorld);const Y=t.update(b),W=b.material;if(Array.isArray(W)){const F=Y.groups;for(let G=0,H=F.length;G<H;G++){const tt=F[G],et=W[tt.materialIndex];if(et&&et.visible){const ut=y(b,et,R,N);b.onBeforeShadow(i,b,C,S,Y,ut,tt),i.renderBufferDirect(S,null,Y,ut,b,tt),b.onAfterShadow(i,b,C,S,Y,ut,tt)}}}else if(W.visible){const F=y(b,W,R,N);b.onBeforeShadow(i,b,C,S,Y,F,null),i.renderBufferDirect(S,null,Y,F,b,null),b.onAfterShadow(i,b,C,S,Y,F,null)}}const B=b.children;for(let Y=0,W=B.length;Y<W;Y++)M(B[Y],C,S,R,N)}function T(b){b.target.removeEventListener("dispose",T);for(const S in l){const R=l[S],N=b.target.uuid;N in R&&(R[N].dispose(),delete R[N])}}}function t0(i,t){function e(){let D=!1;const st=new _e;let q=null;const _t=new _e(0,0,0,0);return{setMask:function(at){q!==at&&!D&&(i.colorMask(at,at,at,at),q=at)},setLocked:function(at){D=at},setClear:function(at,$,Et,It,ve){ve===!0&&(at*=It,$*=It,Et*=It),st.set(at,$,Et,It),_t.equals(st)===!1&&(i.clearColor(at,$,Et,It),_t.copy(st))},reset:function(){D=!1,q=null,_t.set(-1,0,0,0)}}}function n(){let D=!1,st=!1,q=null,_t=null,at=null;return{setReversed:function($){if(st!==$){const Et=t.get("EXT_clip_control");$?Et.clipControlEXT(Et.LOWER_LEFT_EXT,Et.ZERO_TO_ONE_EXT):Et.clipControlEXT(Et.LOWER_LEFT_EXT,Et.NEGATIVE_ONE_TO_ONE_EXT),st=$;const It=at;at=null,this.setClear(It)}},getReversed:function(){return st},setTest:function($){$?rt(i.DEPTH_TEST):Rt(i.DEPTH_TEST)},setMask:function($){q!==$&&!D&&(i.depthMask($),q=$)},setFunc:function($){if(st&&($=Gh[$]),_t!==$){switch($){case co:i.depthFunc(i.NEVER);break;case lo:i.depthFunc(i.ALWAYS);break;case ho:i.depthFunc(i.LESS);break;case ki:i.depthFunc(i.LEQUAL);break;case uo:i.depthFunc(i.EQUAL);break;case fo:i.depthFunc(i.GEQUAL);break;case po:i.depthFunc(i.GREATER);break;case mo:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}_t=$}},setLocked:function($){D=$},setClear:function($){at!==$&&(at=$,st&&($=1-$),i.clearDepth($))},reset:function(){D=!1,q=null,_t=null,at=null,st=!1}}}function s(){let D=!1,st=null,q=null,_t=null,at=null,$=null,Et=null,It=null,ve=null;return{setTest:function(Qt){D||(Qt?rt(i.STENCIL_TEST):Rt(i.STENCIL_TEST))},setMask:function(Qt){st!==Qt&&!D&&(i.stencilMask(Qt),st=Qt)},setFunc:function(Qt,An,dn){(q!==Qt||_t!==An||at!==dn)&&(i.stencilFunc(Qt,An,dn),q=Qt,_t=An,at=dn)},setOp:function(Qt,An,dn){($!==Qt||Et!==An||It!==dn)&&(i.stencilOp(Qt,An,dn),$=Qt,Et=An,It=dn)},setLocked:function(Qt){D=Qt},setClear:function(Qt){ve!==Qt&&(i.clearStencil(Qt),ve=Qt)},reset:function(){D=!1,st=null,q=null,_t=null,at=null,$=null,Et=null,It=null,ve=null}}}const r=new e,o=new n,a=new s,c=new WeakMap,l=new WeakMap;let d={},u={},h={},f=new WeakMap,g=[],x=null,m=!1,p=null,_=null,y=null,M=null,T=null,b=null,C=null,S=new Xt(0,0,0),R=0,N=!1,L=null,B=null,Y=null,W=null,F=null;const G=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,tt=0;const et=i.getParameter(i.VERSION);et.indexOf("WebGL")!==-1?(tt=parseFloat(/^WebGL (\d)/.exec(et)[1]),H=tt>=1):et.indexOf("OpenGL ES")!==-1&&(tt=parseFloat(/^OpenGL ES (\d)/.exec(et)[1]),H=tt>=2);let ut=null,St={};const Tt=i.getParameter(i.SCISSOR_BOX),Yt=i.getParameter(i.VIEWPORT),$t=new _e().fromArray(Tt),Nt=new _e().fromArray(Yt);function K(D,st,q,_t){const at=new Uint8Array(4),$=i.createTexture();i.bindTexture(D,$),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Et=0;Et<q;Et++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(st,0,i.RGBA,1,1,_t,0,i.RGBA,i.UNSIGNED_BYTE,at):i.texImage2D(st+Et,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,at);return $}const pt={};pt[i.TEXTURE_2D]=K(i.TEXTURE_2D,i.TEXTURE_2D,1),pt[i.TEXTURE_CUBE_MAP]=K(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),pt[i.TEXTURE_2D_ARRAY]=K(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),pt[i.TEXTURE_3D]=K(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),rt(i.DEPTH_TEST),o.setFunc(ki),be(!1),fe(Oa),rt(i.CULL_FACE),ce(Bn);function rt(D){d[D]!==!0&&(i.enable(D),d[D]=!0)}function Rt(D){d[D]!==!1&&(i.disable(D),d[D]=!1)}function Lt(D,st){return h[D]!==st?(i.bindFramebuffer(D,st),h[D]=st,D===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=st),D===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=st),!0):!1}function Ct(D,st){let q=g,_t=!1;if(D){q=f.get(st),q===void 0&&(q=[],f.set(st,q));const at=D.textures;if(q.length!==at.length||q[0]!==i.COLOR_ATTACHMENT0){for(let $=0,Et=at.length;$<Et;$++)q[$]=i.COLOR_ATTACHMENT0+$;q.length=at.length,_t=!0}}else q[0]!==i.BACK&&(q[0]=i.BACK,_t=!0);_t&&i.drawBuffers(q)}function de(D){return x!==D?(i.useProgram(D),x=D,!0):!1}const Gt={[li]:i.FUNC_ADD,[lh]:i.FUNC_SUBTRACT,[hh]:i.FUNC_REVERSE_SUBTRACT};Gt[uh]=i.MIN,Gt[dh]=i.MAX;const Jt={[fh]:i.ZERO,[ph]:i.ONE,[mh]:i.SRC_COLOR,[oo]:i.SRC_ALPHA,[Sh]:i.SRC_ALPHA_SATURATE,[vh]:i.DST_COLOR,[_h]:i.DST_ALPHA,[gh]:i.ONE_MINUS_SRC_COLOR,[ao]:i.ONE_MINUS_SRC_ALPHA,[yh]:i.ONE_MINUS_DST_COLOR,[xh]:i.ONE_MINUS_DST_ALPHA,[Mh]:i.CONSTANT_COLOR,[Eh]:i.ONE_MINUS_CONSTANT_COLOR,[bh]:i.CONSTANT_ALPHA,[Th]:i.ONE_MINUS_CONSTANT_ALPHA};function ce(D,st,q,_t,at,$,Et,It,ve,Qt){if(D===Bn){m===!0&&(Rt(i.BLEND),m=!1);return}if(m===!1&&(rt(i.BLEND),m=!0),D!==ch){if(D!==p||Qt!==N){if((_!==li||T!==li)&&(i.blendEquation(i.FUNC_ADD),_=li,T=li),Qt)switch(D){case Bi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ba:i.blendFunc(i.ONE,i.ONE);break;case za:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ka:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ht("WebGLState: Invalid blending: ",D);break}else switch(D){case Bi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ba:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case za:Ht("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ka:Ht("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ht("WebGLState: Invalid blending: ",D);break}y=null,M=null,b=null,C=null,S.set(0,0,0),R=0,p=D,N=Qt}return}at=at||st,$=$||q,Et=Et||_t,(st!==_||at!==T)&&(i.blendEquationSeparate(Gt[st],Gt[at]),_=st,T=at),(q!==y||_t!==M||$!==b||Et!==C)&&(i.blendFuncSeparate(Jt[q],Jt[_t],Jt[$],Jt[Et]),y=q,M=_t,b=$,C=Et),(It.equals(S)===!1||ve!==R)&&(i.blendColor(It.r,It.g,It.b,ve),S.copy(It),R=ve),p=D,N=!1}function kt(D,st){D.side===Xe?Rt(i.CULL_FACE):rt(i.CULL_FACE);let q=D.side===qe;st&&(q=!q),be(q),D.blending===Bi&&D.transparent===!1?ce(Bn):ce(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),o.setFunc(D.depthFunc),o.setTest(D.depthTest),o.setMask(D.depthWrite),r.setMask(D.colorWrite);const _t=D.stencilWrite;a.setTest(_t),_t&&(a.setMask(D.stencilWriteMask),a.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),a.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),I(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?rt(i.SAMPLE_ALPHA_TO_COVERAGE):Rt(i.SAMPLE_ALPHA_TO_COVERAGE)}function be(D){L!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),L=D)}function fe(D){D!==rh?(rt(i.CULL_FACE),D!==B&&(D===Oa?i.cullFace(i.BACK):D===oh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Rt(i.CULL_FACE),B=D}function Ze(D){D!==Y&&(H&&i.lineWidth(D),Y=D)}function I(D,st,q){D?(rt(i.POLYGON_OFFSET_FILL),(W!==st||F!==q)&&(W=st,F=q,o.getReversed()&&(st=-st),i.polygonOffset(st,q))):Rt(i.POLYGON_OFFSET_FILL)}function Te(D){D?rt(i.SCISSOR_TEST):Rt(i.SCISSOR_TEST)}function Vt(D){D===void 0&&(D=i.TEXTURE0+G-1),ut!==D&&(i.activeTexture(D),ut=D)}function re(D,st,q){q===void 0&&(ut===null?q=i.TEXTURE0+G-1:q=ut);let _t=St[q];_t===void 0&&(_t={type:void 0,texture:void 0},St[q]=_t),(_t.type!==D||_t.texture!==st)&&(ut!==q&&(i.activeTexture(q),ut=q),i.bindTexture(D,st||pt[D]),_t.type=D,_t.texture=st)}function lt(){const D=St[ut];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function me(){try{i.compressedTexImage2D(...arguments)}catch(D){Ht("WebGLState:",D)}}function A(){try{i.compressedTexImage3D(...arguments)}catch(D){Ht("WebGLState:",D)}}function v(){try{i.texSubImage2D(...arguments)}catch(D){Ht("WebGLState:",D)}}function O(){try{i.texSubImage3D(...arguments)}catch(D){Ht("WebGLState:",D)}}function Z(){try{i.compressedTexSubImage2D(...arguments)}catch(D){Ht("WebGLState:",D)}}function J(){try{i.compressedTexSubImage3D(...arguments)}catch(D){Ht("WebGLState:",D)}}function nt(){try{i.texStorage2D(...arguments)}catch(D){Ht("WebGLState:",D)}}function ct(){try{i.texStorage3D(...arguments)}catch(D){Ht("WebGLState:",D)}}function X(){try{i.texImage2D(...arguments)}catch(D){Ht("WebGLState:",D)}}function j(){try{i.texImage3D(...arguments)}catch(D){Ht("WebGLState:",D)}}function mt(D){return u[D]!==void 0?u[D]:i.getParameter(D)}function vt(D,st){u[D]!==st&&(i.pixelStorei(D,st),u[D]=st)}function ot(D){$t.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),$t.copy(D))}function it(D){Nt.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),Nt.copy(D))}function Pt(D,st){let q=l.get(st);q===void 0&&(q=new WeakMap,l.set(st,q));let _t=q.get(D);_t===void 0&&(_t=i.getUniformBlockIndex(st,D.name),q.set(D,_t))}function Ft(D,st){const _t=l.get(st).get(D);c.get(st)!==_t&&(i.uniformBlockBinding(st,_t,D.__bindingPointIndex),c.set(st,_t))}function Zt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),d={},u={},ut=null,St={},h={},f=new WeakMap,g=[],x=null,m=!1,p=null,_=null,y=null,M=null,T=null,b=null,C=null,S=new Xt(0,0,0),R=0,N=!1,L=null,B=null,Y=null,W=null,F=null,$t.set(0,0,i.canvas.width,i.canvas.height),Nt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:rt,disable:Rt,bindFramebuffer:Lt,drawBuffers:Ct,useProgram:de,setBlending:ce,setMaterial:kt,setFlipSided:be,setCullFace:fe,setLineWidth:Ze,setPolygonOffset:I,setScissorTest:Te,activeTexture:Vt,bindTexture:re,unbindTexture:lt,compressedTexImage2D:me,compressedTexImage3D:A,texImage2D:X,texImage3D:j,pixelStorei:vt,getParameter:mt,updateUBOMapping:Pt,uniformBlockBinding:Ft,texStorage2D:nt,texStorage3D:ct,texSubImage2D:v,texSubImage3D:O,compressedTexSubImage2D:Z,compressedTexSubImage3D:J,scissor:ot,viewport:it,reset:Zt}}function e0(i,t,e,n,s,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new gt,d=new WeakMap,u=new Set;let h;const f=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(A,v){return g?new OffscreenCanvas(A,v):ir("canvas")}function m(A,v,O){let Z=1;const J=me(A);if((J.width>O||J.height>O)&&(Z=O/Math.max(J.width,J.height)),Z<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const nt=Math.floor(Z*J.width),ct=Math.floor(Z*J.height);h===void 0&&(h=x(nt,ct));const X=v?x(nt,ct):h;return X.width=nt,X.height=ct,X.getContext("2d").drawImage(A,0,0,nt,ct),wt("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+nt+"x"+ct+")."),X}else return"data"in A&&wt("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),A;return A}function p(A){return A.generateMipmaps}function _(A){i.generateMipmap(A)}function y(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(A,v,O,Z,J,nt=!1){if(A!==null){if(i[A]!==void 0)return i[A];wt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let ct;Z&&(ct=t.get("EXT_texture_norm16"),ct||wt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let X=v;if(v===i.RED&&(O===i.FLOAT&&(X=i.R32F),O===i.HALF_FLOAT&&(X=i.R16F),O===i.UNSIGNED_BYTE&&(X=i.R8),O===i.UNSIGNED_SHORT&&ct&&(X=ct.R16_EXT),O===i.SHORT&&ct&&(X=ct.R16_SNORM_EXT)),v===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.R8UI),O===i.UNSIGNED_SHORT&&(X=i.R16UI),O===i.UNSIGNED_INT&&(X=i.R32UI),O===i.BYTE&&(X=i.R8I),O===i.SHORT&&(X=i.R16I),O===i.INT&&(X=i.R32I)),v===i.RG&&(O===i.FLOAT&&(X=i.RG32F),O===i.HALF_FLOAT&&(X=i.RG16F),O===i.UNSIGNED_BYTE&&(X=i.RG8),O===i.UNSIGNED_SHORT&&ct&&(X=ct.RG16_EXT),O===i.SHORT&&ct&&(X=ct.RG16_SNORM_EXT)),v===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.RG8UI),O===i.UNSIGNED_SHORT&&(X=i.RG16UI),O===i.UNSIGNED_INT&&(X=i.RG32UI),O===i.BYTE&&(X=i.RG8I),O===i.SHORT&&(X=i.RG16I),O===i.INT&&(X=i.RG32I)),v===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.RGB8UI),O===i.UNSIGNED_SHORT&&(X=i.RGB16UI),O===i.UNSIGNED_INT&&(X=i.RGB32UI),O===i.BYTE&&(X=i.RGB8I),O===i.SHORT&&(X=i.RGB16I),O===i.INT&&(X=i.RGB32I)),v===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),O===i.UNSIGNED_INT&&(X=i.RGBA32UI),O===i.BYTE&&(X=i.RGBA8I),O===i.SHORT&&(X=i.RGBA16I),O===i.INT&&(X=i.RGBA32I)),v===i.RGB&&(O===i.UNSIGNED_SHORT&&ct&&(X=ct.RGB16_EXT),O===i.SHORT&&ct&&(X=ct.RGB16_SNORM_EXT),O===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(X=i.R11F_G11F_B10F)),v===i.RGBA){const j=nt?nr:Wt.getTransfer(J);O===i.FLOAT&&(X=i.RGBA32F),O===i.HALF_FLOAT&&(X=i.RGBA16F),O===i.UNSIGNED_BYTE&&(X=j===Kt?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT&&ct&&(X=ct.RGBA16_EXT),O===i.SHORT&&ct&&(X=ct.RGBA16_SNORM_EXT),O===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&t.get("EXT_color_buffer_float"),X}function T(A,v){let O;return A?v===null||v===En||v===as?O=i.DEPTH24_STENCIL8:v===xn?O=i.DEPTH32F_STENCIL8:v===os&&(O=i.DEPTH24_STENCIL8,wt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===En||v===as?O=i.DEPTH_COMPONENT24:v===xn?O=i.DEPTH_COMPONENT32F:v===os&&(O=i.DEPTH_COMPONENT16),O}function b(A,v){return p(A)===!0||A.isFramebufferTexture&&A.minFilter!==De&&A.minFilter!==Oe?Math.log2(Math.max(v.width,v.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?v.mipmaps.length:1}function C(A){const v=A.target;v.removeEventListener("dispose",C),R(v),v.isVideoTexture&&d.delete(v),v.isHTMLTexture&&u.delete(v)}function S(A){const v=A.target;v.removeEventListener("dispose",S),L(v)}function R(A){const v=n.get(A);if(v.__webglInit===void 0)return;const O=A.source,Z=f.get(O);if(Z){const J=Z[v.__cacheKey];J.usedTimes--,J.usedTimes===0&&N(A),Object.keys(Z).length===0&&f.delete(O)}n.remove(A)}function N(A){const v=n.get(A);i.deleteTexture(v.__webglTexture);const O=A.source,Z=f.get(O);delete Z[v.__cacheKey],o.memory.textures--}function L(A){const v=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(v.__webglFramebuffer[Z]))for(let J=0;J<v.__webglFramebuffer[Z].length;J++)i.deleteFramebuffer(v.__webglFramebuffer[Z][J]);else i.deleteFramebuffer(v.__webglFramebuffer[Z]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[Z])}else{if(Array.isArray(v.__webglFramebuffer))for(let Z=0;Z<v.__webglFramebuffer.length;Z++)i.deleteFramebuffer(v.__webglFramebuffer[Z]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Z=0;Z<v.__webglColorRenderbuffer.length;Z++)v.__webglColorRenderbuffer[Z]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[Z]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const O=A.textures;for(let Z=0,J=O.length;Z<J;Z++){const nt=n.get(O[Z]);nt.__webglTexture&&(i.deleteTexture(nt.__webglTexture),o.memory.textures--),n.remove(O[Z])}n.remove(A)}let B=0;function Y(){B=0}function W(){return B}function F(A){B=A}function G(){const A=B;return A>=s.maxTextures&&wt("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),B+=1,A}function H(A){const v=[];return v.push(A.wrapS),v.push(A.wrapT),v.push(A.wrapR||0),v.push(A.magFilter),v.push(A.minFilter),v.push(A.anisotropy),v.push(A.internalFormat),v.push(A.format),v.push(A.type),v.push(A.generateMipmaps),v.push(A.premultiplyAlpha),v.push(A.flipY),v.push(A.unpackAlignment),v.push(A.colorSpace),v.join()}function tt(A,v){const O=n.get(A);if(A.isVideoTexture&&re(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&O.__version!==A.version){const Z=A.image;if(Z===null)wt("WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)wt("WebGLRenderer: Texture marked for update but image is incomplete");else{Rt(O,A,v);return}}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+v)}function et(A,v){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){Rt(O,A,v);return}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+v)}function ut(A,v){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){Rt(O,A,v);return}e.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+v)}function St(A,v){const O=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&O.__version!==A.version){Lt(O,A,v);return}e.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+v)}const Tt={[go]:i.REPEAT,[Fn]:i.CLAMP_TO_EDGE,[_o]:i.MIRRORED_REPEAT},Yt={[De]:i.NEAREST,[Rh]:i.NEAREST_MIPMAP_NEAREST,[xs]:i.NEAREST_MIPMAP_LINEAR,[Oe]:i.LINEAR,[Er]:i.LINEAR_MIPMAP_NEAREST,[di]:i.LINEAR_MIPMAP_LINEAR},$t={[Lh]:i.NEVER,[Fh]:i.ALWAYS,[Dh]:i.LESS,[pa]:i.LEQUAL,[Ih]:i.EQUAL,[ma]:i.GEQUAL,[Uh]:i.GREATER,[Nh]:i.NOTEQUAL};function Nt(A,v){if(v.type===xn&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===Oe||v.magFilter===Er||v.magFilter===xs||v.magFilter===di||v.minFilter===Oe||v.minFilter===Er||v.minFilter===xs||v.minFilter===di)&&wt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,Tt[v.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,Tt[v.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,Tt[v.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,Yt[v.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,Yt[v.minFilter]),v.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,$t[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===De||v.minFilter!==xs&&v.minFilter!==di||v.type===xn&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const O=t.get("EXT_texture_filter_anisotropic");i.texParameterf(A,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function K(A,v){let O=!1;A.__webglInit===void 0&&(A.__webglInit=!0,v.addEventListener("dispose",C));const Z=v.source;let J=f.get(Z);J===void 0&&(J={},f.set(Z,J));const nt=H(v);if(nt!==A.__cacheKey){J[nt]===void 0&&(J[nt]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,O=!0),J[nt].usedTimes++;const ct=J[A.__cacheKey];ct!==void 0&&(J[A.__cacheKey].usedTimes--,ct.usedTimes===0&&N(v)),A.__cacheKey=nt,A.__webglTexture=J[nt].texture}return O}function pt(A,v,O){return Math.floor(Math.floor(A/O)/v)}function rt(A,v,O,Z){const nt=A.updateRanges;if(nt.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,v.width,v.height,O,Z,v.data);else{nt.sort((vt,ot)=>vt.start-ot.start);let ct=0;for(let vt=1;vt<nt.length;vt++){const ot=nt[ct],it=nt[vt],Pt=ot.start+ot.count,Ft=pt(it.start,v.width,4),Zt=pt(ot.start,v.width,4);it.start<=Pt+1&&Ft===Zt&&pt(it.start+it.count-1,v.width,4)===Ft?ot.count=Math.max(ot.count,it.start+it.count-ot.start):(++ct,nt[ct]=it)}nt.length=ct+1;const X=e.getParameter(i.UNPACK_ROW_LENGTH),j=e.getParameter(i.UNPACK_SKIP_PIXELS),mt=e.getParameter(i.UNPACK_SKIP_ROWS);e.pixelStorei(i.UNPACK_ROW_LENGTH,v.width);for(let vt=0,ot=nt.length;vt<ot;vt++){const it=nt[vt],Pt=Math.floor(it.start/4),Ft=Math.ceil(it.count/4),Zt=Pt%v.width,D=Math.floor(Pt/v.width),st=Ft,q=1;e.pixelStorei(i.UNPACK_SKIP_PIXELS,Zt),e.pixelStorei(i.UNPACK_SKIP_ROWS,D),e.texSubImage2D(i.TEXTURE_2D,0,Zt,D,st,q,O,Z,v.data)}A.clearUpdateRanges(),e.pixelStorei(i.UNPACK_ROW_LENGTH,X),e.pixelStorei(i.UNPACK_SKIP_PIXELS,j),e.pixelStorei(i.UNPACK_SKIP_ROWS,mt)}}function Rt(A,v,O){let Z=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Z=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Z=i.TEXTURE_3D);const J=K(A,v),nt=v.source;e.bindTexture(Z,A.__webglTexture,i.TEXTURE0+O);const ct=n.get(nt);if(nt.version!==ct.__version||J===!0){if(e.activeTexture(i.TEXTURE0+O),(typeof ImageBitmap<"u"&&v.image instanceof ImageBitmap)===!1){const q=Wt.getPrimaries(Wt.workingColorSpace),_t=v.colorSpace===Qn?null:Wt.getPrimaries(v.colorSpace),at=v.colorSpace===Qn||q===_t?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,at)}e.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment);let j=m(v.image,!1,s.maxTextureSize);j=lt(v,j);const mt=r.convert(v.format,v.colorSpace),vt=r.convert(v.type);let ot=M(v.internalFormat,mt,vt,v.normalized,v.colorSpace,v.isVideoTexture);Nt(Z,v);let it;const Pt=v.mipmaps,Ft=v.isVideoTexture!==!0,Zt=ct.__version===void 0||J===!0,D=nt.dataReady,st=b(v,j);if(v.isDepthTexture)ot=T(v.format===fi,v.type),Zt&&(Ft?e.texStorage2D(i.TEXTURE_2D,1,ot,j.width,j.height):e.texImage2D(i.TEXTURE_2D,0,ot,j.width,j.height,0,mt,vt,null));else if(v.isDataTexture)if(Pt.length>0){Ft&&Zt&&e.texStorage2D(i.TEXTURE_2D,st,ot,Pt[0].width,Pt[0].height);for(let q=0,_t=Pt.length;q<_t;q++)it=Pt[q],Ft?D&&e.texSubImage2D(i.TEXTURE_2D,q,0,0,it.width,it.height,mt,vt,it.data):e.texImage2D(i.TEXTURE_2D,q,ot,it.width,it.height,0,mt,vt,it.data);v.generateMipmaps=!1}else Ft?(Zt&&e.texStorage2D(i.TEXTURE_2D,st,ot,j.width,j.height),D&&rt(v,j,mt,vt)):e.texImage2D(i.TEXTURE_2D,0,ot,j.width,j.height,0,mt,vt,j.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Ft&&Zt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,st,ot,Pt[0].width,Pt[0].height,j.depth);for(let q=0,_t=Pt.length;q<_t;q++)if(it=Pt[q],v.format!==un)if(mt!==null)if(Ft){if(D)if(v.layerUpdates.size>0){const at=Pc(it.width,it.height,v.format,v.type);for(const $ of v.layerUpdates){const Et=it.data.subarray($*at/it.data.BYTES_PER_ELEMENT,($+1)*at/it.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,$,it.width,it.height,1,mt,Et)}v.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,it.width,it.height,j.depth,mt,it.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,q,ot,it.width,it.height,j.depth,0,it.data,0,0);else wt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ft?D&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,it.width,it.height,j.depth,mt,vt,it.data):e.texImage3D(i.TEXTURE_2D_ARRAY,q,ot,it.width,it.height,j.depth,0,mt,vt,it.data)}else{Ft&&Zt&&e.texStorage2D(i.TEXTURE_2D,st,ot,Pt[0].width,Pt[0].height);for(let q=0,_t=Pt.length;q<_t;q++)it=Pt[q],v.format!==un?mt!==null?Ft?D&&e.compressedTexSubImage2D(i.TEXTURE_2D,q,0,0,it.width,it.height,mt,it.data):e.compressedTexImage2D(i.TEXTURE_2D,q,ot,it.width,it.height,0,it.data):wt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ft?D&&e.texSubImage2D(i.TEXTURE_2D,q,0,0,it.width,it.height,mt,vt,it.data):e.texImage2D(i.TEXTURE_2D,q,ot,it.width,it.height,0,mt,vt,it.data)}else if(v.isDataArrayTexture)if(Ft){if(Zt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,st,ot,j.width,j.height,j.depth),D)if(v.layerUpdates.size>0){const q=Pc(j.width,j.height,v.format,v.type);for(const _t of v.layerUpdates){const at=j.data.subarray(_t*q/j.data.BYTES_PER_ELEMENT,(_t+1)*q/j.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,_t,j.width,j.height,1,mt,vt,at)}v.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,j.width,j.height,j.depth,mt,vt,j.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,ot,j.width,j.height,j.depth,0,mt,vt,j.data);else if(v.isData3DTexture)Ft?(Zt&&e.texStorage3D(i.TEXTURE_3D,st,ot,j.width,j.height,j.depth),D&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,j.width,j.height,j.depth,mt,vt,j.data)):e.texImage3D(i.TEXTURE_3D,0,ot,j.width,j.height,j.depth,0,mt,vt,j.data);else if(v.isFramebufferTexture){if(Zt)if(Ft)e.texStorage2D(i.TEXTURE_2D,st,ot,j.width,j.height);else{let q=j.width,_t=j.height;for(let at=0;at<st;at++)e.texImage2D(i.TEXTURE_2D,at,ot,q,_t,0,mt,vt,null),q>>=1,_t>>=1}}else if(v.isHTMLTexture){if("texElementImage2D"in i){const q=i.canvas;if(q.hasAttribute("layoutsubtree")||q.setAttribute("layoutsubtree","true"),j.parentNode!==q){q.appendChild(j),u.add(v),q.onpaint=It=>{const ve=It.changedElements;for(const Qt of u)ve.includes(Qt.image)&&(Qt.needsUpdate=!0)},q.requestPaint();return}const _t=0,at=i.RGBA,$=i.RGBA,Et=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,_t,at,$,Et,j),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Pt.length>0){if(Ft&&Zt){const q=me(Pt[0]);e.texStorage2D(i.TEXTURE_2D,st,ot,q.width,q.height)}for(let q=0,_t=Pt.length;q<_t;q++)it=Pt[q],Ft?D&&e.texSubImage2D(i.TEXTURE_2D,q,0,0,mt,vt,it):e.texImage2D(i.TEXTURE_2D,q,ot,mt,vt,it);v.generateMipmaps=!1}else if(Ft){if(Zt){const q=me(j);e.texStorage2D(i.TEXTURE_2D,st,ot,q.width,q.height)}D&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,mt,vt,j)}else e.texImage2D(i.TEXTURE_2D,0,ot,mt,vt,j);p(v)&&_(Z),ct.__version=nt.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function Lt(A,v,O){if(v.image.length!==6)return;const Z=K(A,v),J=v.source;e.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+O);const nt=n.get(J);if(J.version!==nt.__version||Z===!0){e.activeTexture(i.TEXTURE0+O);const ct=Wt.getPrimaries(Wt.workingColorSpace),X=v.colorSpace===Qn?null:Wt.getPrimaries(v.colorSpace),j=v.colorSpace===Qn||ct===X?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),e.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,j);const mt=v.isCompressedTexture||v.image[0].isCompressedTexture,vt=v.image[0]&&v.image[0].isDataTexture,ot=[];for(let $=0;$<6;$++)!mt&&!vt?ot[$]=m(v.image[$],!0,s.maxCubemapSize):ot[$]=vt?v.image[$].image:v.image[$],ot[$]=lt(v,ot[$]);const it=ot[0],Pt=r.convert(v.format,v.colorSpace),Ft=r.convert(v.type),Zt=M(v.internalFormat,Pt,Ft,v.normalized,v.colorSpace),D=v.isVideoTexture!==!0,st=nt.__version===void 0||Z===!0,q=J.dataReady;let _t=b(v,it);Nt(i.TEXTURE_CUBE_MAP,v);let at;if(mt){D&&st&&e.texStorage2D(i.TEXTURE_CUBE_MAP,_t,Zt,it.width,it.height);for(let $=0;$<6;$++){at=ot[$].mipmaps;for(let Et=0;Et<at.length;Et++){const It=at[Et];v.format!==un?Pt!==null?D?q&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Et,0,0,It.width,It.height,Pt,It.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Et,Zt,It.width,It.height,0,It.data):wt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?q&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Et,0,0,It.width,It.height,Pt,Ft,It.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Et,Zt,It.width,It.height,0,Pt,Ft,It.data)}}}else{if(at=v.mipmaps,D&&st){at.length>0&&_t++;const $=me(ot[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,_t,Zt,$.width,$.height)}for(let $=0;$<6;$++)if(vt){D?q&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,ot[$].width,ot[$].height,Pt,Ft,ot[$].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Zt,ot[$].width,ot[$].height,0,Pt,Ft,ot[$].data);for(let Et=0;Et<at.length;Et++){const ve=at[Et].image[$].image;D?q&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Et+1,0,0,ve.width,ve.height,Pt,Ft,ve.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Et+1,Zt,ve.width,ve.height,0,Pt,Ft,ve.data)}}else{D?q&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,Pt,Ft,ot[$]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Zt,Pt,Ft,ot[$]);for(let Et=0;Et<at.length;Et++){const It=at[Et];D?q&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Et+1,0,0,Pt,Ft,It.image[$]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Et+1,Zt,Pt,Ft,It.image[$])}}}p(v)&&_(i.TEXTURE_CUBE_MAP),nt.__version=J.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function Ct(A,v,O,Z,J,nt){const ct=r.convert(O.format,O.colorSpace),X=r.convert(O.type),j=M(O.internalFormat,ct,X,O.normalized,O.colorSpace),mt=n.get(v),vt=n.get(O);if(vt.__renderTarget=v,!mt.__hasExternalTextures){const ot=Math.max(1,v.width>>nt),it=Math.max(1,v.height>>nt);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,nt,j,ot,it,v.depth,0,ct,X,null):e.texImage2D(J,nt,j,ot,it,0,ct,X,null)}e.bindFramebuffer(i.FRAMEBUFFER,A),Vt(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,J,vt.__webglTexture,0,Te(v)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Z,J,vt.__webglTexture,nt),e.bindFramebuffer(i.FRAMEBUFFER,null)}function de(A,v,O){if(i.bindRenderbuffer(i.RENDERBUFFER,A),v.depthBuffer){const Z=v.depthTexture,J=Z&&Z.isDepthTexture?Z.type:null,nt=T(v.stencilBuffer,J),ct=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Vt(v)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Te(v),nt,v.width,v.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,Te(v),nt,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,nt,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ct,i.RENDERBUFFER,A)}else{const Z=v.textures;for(let J=0;J<Z.length;J++){const nt=Z[J],ct=r.convert(nt.format,nt.colorSpace),X=r.convert(nt.type),j=M(nt.internalFormat,ct,X,nt.normalized,nt.colorSpace);Vt(v)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Te(v),j,v.width,v.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,Te(v),j,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,j,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Gt(A,v,O){const Z=v.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,A),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const J=n.get(v.depthTexture);if(J.__renderTarget=v,(!J.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Z){if(J.__webglInit===void 0&&(J.__webglInit=!0,v.depthTexture.addEventListener("dispose",C)),J.__webglTexture===void 0){J.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,J.__webglTexture),Nt(i.TEXTURE_CUBE_MAP,v.depthTexture);const mt=r.convert(v.depthTexture.format),vt=r.convert(v.depthTexture.type);let ot;v.depthTexture.format===Vn?ot=i.DEPTH_COMPONENT24:v.depthTexture.format===fi&&(ot=i.DEPTH24_STENCIL8);for(let it=0;it<6;it++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,0,ot,v.width,v.height,0,mt,vt,null)}}else tt(v.depthTexture,0);const nt=J.__webglTexture,ct=Te(v),X=Z?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,j=v.depthTexture.format===fi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(v.depthTexture.format===Vn)Vt(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,j,X,nt,0,ct):i.framebufferTexture2D(i.FRAMEBUFFER,j,X,nt,0);else if(v.depthTexture.format===fi)Vt(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,j,X,nt,0,ct):i.framebufferTexture2D(i.FRAMEBUFFER,j,X,nt,0);else throw new Error("Unknown depthTexture format")}function Jt(A){const v=n.get(A),O=A.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==A.depthTexture){const Z=A.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Z){const J=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Z.removeEventListener("dispose",J)};Z.addEventListener("dispose",J),v.__depthDisposeCallback=J}v.__boundDepthTexture=Z}if(A.depthTexture&&!v.__autoAllocateDepthBuffer)if(O)for(let Z=0;Z<6;Z++)Gt(v.__webglFramebuffer[Z],A,Z);else{const Z=A.texture.mipmaps;Z&&Z.length>0?Gt(v.__webglFramebuffer[0],A,0):Gt(v.__webglFramebuffer,A,0)}else if(O){v.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[Z]),v.__webglDepthbuffer[Z]===void 0)v.__webglDepthbuffer[Z]=i.createRenderbuffer(),de(v.__webglDepthbuffer[Z],A,!1);else{const J=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,nt=v.__webglDepthbuffer[Z];i.bindRenderbuffer(i.RENDERBUFFER,nt),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,nt)}}else{const Z=A.texture.mipmaps;if(Z&&Z.length>0?e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=i.createRenderbuffer(),de(v.__webglDepthbuffer,A,!1);else{const J=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,nt=v.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,nt),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,nt)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function ce(A,v,O){const Z=n.get(A);v!==void 0&&Ct(Z.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Jt(A)}function kt(A){const v=A.texture,O=n.get(A),Z=n.get(v);A.addEventListener("dispose",S);const J=A.textures,nt=A.isWebGLCubeRenderTarget===!0,ct=J.length>1;if(ct||(Z.__webglTexture===void 0&&(Z.__webglTexture=i.createTexture()),Z.__version=v.version,o.memory.textures++),nt){O.__webglFramebuffer=[];for(let X=0;X<6;X++)if(v.mipmaps&&v.mipmaps.length>0){O.__webglFramebuffer[X]=[];for(let j=0;j<v.mipmaps.length;j++)O.__webglFramebuffer[X][j]=i.createFramebuffer()}else O.__webglFramebuffer[X]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){O.__webglFramebuffer=[];for(let X=0;X<v.mipmaps.length;X++)O.__webglFramebuffer[X]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(ct)for(let X=0,j=J.length;X<j;X++){const mt=n.get(J[X]);mt.__webglTexture===void 0&&(mt.__webglTexture=i.createTexture(),o.memory.textures++)}if(A.samples>0&&Vt(A)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let X=0;X<J.length;X++){const j=J[X];O.__webglColorRenderbuffer[X]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[X]);const mt=r.convert(j.format,j.colorSpace),vt=r.convert(j.type),ot=M(j.internalFormat,mt,vt,j.normalized,j.colorSpace,A.isXRRenderTarget===!0),it=Te(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,it,ot,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+X,i.RENDERBUFFER,O.__webglColorRenderbuffer[X])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),de(O.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(nt){e.bindTexture(i.TEXTURE_CUBE_MAP,Z.__webglTexture),Nt(i.TEXTURE_CUBE_MAP,v);for(let X=0;X<6;X++)if(v.mipmaps&&v.mipmaps.length>0)for(let j=0;j<v.mipmaps.length;j++)Ct(O.__webglFramebuffer[X][j],A,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+X,j);else Ct(O.__webglFramebuffer[X],A,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0);p(v)&&_(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ct){for(let X=0,j=J.length;X<j;X++){const mt=J[X],vt=n.get(mt);let ot=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ot=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ot,vt.__webglTexture),Nt(ot,mt),Ct(O.__webglFramebuffer,A,mt,i.COLOR_ATTACHMENT0+X,ot,0),p(mt)&&_(ot)}e.unbindTexture()}else{let X=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(X=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(X,Z.__webglTexture),Nt(X,v),v.mipmaps&&v.mipmaps.length>0)for(let j=0;j<v.mipmaps.length;j++)Ct(O.__webglFramebuffer[j],A,v,i.COLOR_ATTACHMENT0,X,j);else Ct(O.__webglFramebuffer,A,v,i.COLOR_ATTACHMENT0,X,0);p(v)&&_(X),e.unbindTexture()}A.depthBuffer&&Jt(A)}function be(A){const v=A.textures;for(let O=0,Z=v.length;O<Z;O++){const J=v[O];if(p(J)){const nt=y(A),ct=n.get(J).__webglTexture;e.bindTexture(nt,ct),_(nt),e.unbindTexture()}}}const fe=[],Ze=[];function I(A){if(A.samples>0){if(Vt(A)===!1){const v=A.textures,O=A.width,Z=A.height;let J=i.COLOR_BUFFER_BIT;const nt=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ct=n.get(A),X=v.length>1;if(X)for(let mt=0;mt<v.length;mt++)e.bindFramebuffer(i.FRAMEBUFFER,ct.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+mt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,ct.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+mt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,ct.__webglMultisampledFramebuffer);const j=A.texture.mipmaps;j&&j.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ct.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ct.__webglFramebuffer);for(let mt=0;mt<v.length;mt++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),X){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ct.__webglColorRenderbuffer[mt]);const vt=n.get(v[mt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,vt,0)}i.blitFramebuffer(0,0,O,Z,0,0,O,Z,J,i.NEAREST),c===!0&&(fe.length=0,Ze.length=0,fe.push(i.COLOR_ATTACHMENT0+mt),A.depthBuffer&&A.resolveDepthBuffer===!1&&(fe.push(nt),Ze.push(nt),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ze)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,fe))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),X)for(let mt=0;mt<v.length;mt++){e.bindFramebuffer(i.FRAMEBUFFER,ct.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+mt,i.RENDERBUFFER,ct.__webglColorRenderbuffer[mt]);const vt=n.get(v[mt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,ct.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+mt,i.TEXTURE_2D,vt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ct.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&c){const v=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function Te(A){return Math.min(s.maxSamples,A.samples)}function Vt(A){const v=n.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function re(A){const v=o.render.frame;d.get(A)!==v&&(d.set(A,v),A.update())}function lt(A,v){const O=A.colorSpace,Z=A.format,J=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||O!==er&&O!==Qn&&(Wt.getTransfer(O)===Kt?(Z!==un||J!==Je)&&wt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ht("WebGLTextures: Unsupported texture color space:",O)),v}function me(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(l.width=A.naturalWidth||A.width,l.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(l.width=A.displayWidth,l.height=A.displayHeight):(l.width=A.width,l.height=A.height),l}this.allocateTextureUnit=G,this.resetTextureUnits=Y,this.getTextureUnits=W,this.setTextureUnits=F,this.setTexture2D=tt,this.setTexture2DArray=et,this.setTexture3D=ut,this.setTextureCube=St,this.rebindTextures=ce,this.setupRenderTarget=kt,this.updateRenderTargetMipmap=be,this.updateMultisampleRenderTarget=I,this.setupDepthRenderbuffer=Jt,this.setupFrameBufferTexture=Ct,this.useMultisampledRTT=Vt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function n0(i,t){function e(n,s=Qn){let r;const o=Wt.getTransfer(s);if(n===Je)return i.UNSIGNED_BYTE;if(n===la)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ha)return i.UNSIGNED_SHORT_5_5_5_1;if(n===ml)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===gl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===fl)return i.BYTE;if(n===pl)return i.SHORT;if(n===os)return i.UNSIGNED_SHORT;if(n===ca)return i.INT;if(n===En)return i.UNSIGNED_INT;if(n===xn)return i.FLOAT;if(n===Gn)return i.HALF_FLOAT;if(n===_l)return i.ALPHA;if(n===xl)return i.RGB;if(n===un)return i.RGBA;if(n===Vn)return i.DEPTH_COMPONENT;if(n===fi)return i.DEPTH_STENCIL;if(n===vl)return i.RED;if(n===ua)return i.RED_INTEGER;if(n===mi)return i.RG;if(n===da)return i.RG_INTEGER;if(n===fa)return i.RGBA_INTEGER;if(n===qs||n===Zs||n===js||n===Ks)if(o===Kt)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===qs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Zs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ks)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===qs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Zs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ks)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===xo||n===vo||n===yo||n===So)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===xo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===vo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===yo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===So)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Mo||n===Eo||n===bo||n===To||n===Ao||n===Qs||n===wo)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Mo||n===Eo)return o===Kt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===bo)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===To)return r.COMPRESSED_R11_EAC;if(n===Ao)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Qs)return r.COMPRESSED_RG11_EAC;if(n===wo)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Ro||n===Co||n===Po||n===Lo||n===Do||n===Io||n===Uo||n===No||n===Fo||n===Oo||n===Bo||n===zo||n===ko||n===Go)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ro)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Co)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Po)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Lo)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Do)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Io)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Uo)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===No)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Fo)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Oo)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Bo)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===zo)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ko)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Go)return o===Kt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Vo||n===Ho||n===Wo)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Vo)return o===Kt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ho)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Wo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Xo||n===Yo||n===tr||n===qo)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===Xo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Yo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===tr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===qo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===as?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const i0=`
void main() {
