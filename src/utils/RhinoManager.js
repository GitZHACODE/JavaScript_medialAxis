    ...
    exportSceneTo3dm(filename = "medial_axis_export.3dm") {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.worker.postMessage({
                ...
                show3DColumns: this.appContext.state.showGroup3DGeometry && this.appContext.state.show3DColumns,
                show3DBeams: this.appContext.state.showGroup3DGeometry && this.appContext.state.show3DBeams,
                showFloorSlabs: this.appContext.state.showGroup3DGeometry && this.appContext.state.showFloorSlabs,
                showRoofSlab: this.appContext.state.showGroup3DGeometry && this.appContext.state.showRoofSlab,
                showBriseSoleil: this.appContext.state.showGroup3DGeometry && this.appContext.state.showBriseSoleil,
                show3DCells: this.appContext.state.showGroupCellsInteraction && this.appContext.state.show3DCells,
                ...
                showVaultedRoofs: this.appContext.state.showGroup3DGeometry && this.appContext.state.showVaultedRoofs,
